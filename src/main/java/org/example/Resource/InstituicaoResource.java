...
@Path("/instituicao")
public class InstituicaoResource implements Loggable<String>{
    ...
    public Response create(Instituicao instituicao)
    {
        try
        {
            instituicaoRepository.Create(instituicao);
    ...
    public Response read(@PathParam("id")int id)
    {
        try{
            ...
            return Response.ok(instituicaoRepository.SearchById(id)).build();
        } catch (Exception e) {
