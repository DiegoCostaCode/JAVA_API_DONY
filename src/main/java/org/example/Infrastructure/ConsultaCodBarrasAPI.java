...
public class ConsultaCodBarrasAPI extends UsuarioRepository implements Loggable<String> {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        while(next){
            ...
            System.out.print("De 1 a 5 por favor, escolha a categoria do produto reciclável: \n 1 - Plástico;\n 2 - Lata;\n 3 - Vidro;\n4 - Papel;\n5 - Tecido algodão;\n");
            ...
            switch (category) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    material = materiais.stream().filter(m -> m.getId_entidade() == 7).findFirst().orElse(null);
                    break;
                case 5:
                    material = materiais.stream().filter(m -> m.getId_entidade() == 8).findFirst().orElse(null);
                    break;
                default:
